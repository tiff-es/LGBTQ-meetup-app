...
User.create_or_find_by(id: 0, name: 'Tiffany', picture: 'https://media-exp1.licdn.com/dms/image/C4D03AQFxelN7X2pP-A/profile-displayphoto-shrink_200_200/0?e=1583971200&v=beta&t=zSCOXIkU-rd3PEXJpkTeucjMfRsemZBtUKitN82yR9k',
...
Meetup.create_or_find_by(id: 0, category_id: 0, location: 'Alexandria,VA', date: Date.current, time: Time.current, info: 'Hang out with fellow trans-spectrum people at a quaint Alexandria coffeeshop', name: 'Trans-Coffee')
Meetup.create_or_find_by(id: 1, category_id: 1, location: 'Washington DC', date: Date.current, time: Time.current, info: 'D.C. LGBTQ+ bar, half off drinks when you bring a friend!', name: 'Lesbian Happy Hour')
Meetup.create_or_find_by(id: 2, category_id: 2, location: 'New York City, NY', date: Date.current, time: Time.current, info: 'Central park hangout', name: 'Gay Pride Central Park')
